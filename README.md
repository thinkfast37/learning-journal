...
## Nov 12 - Leetcode, AI learning, App Scripts

I've been doing leetcode problems in python, doing interviews which also required study/assignments, and I have been using ChatGPT in great detail for investment research.  I also used it to build a script to pull financial statements and populate a valuation calculator sheet I created.  Using the content I also get ChatGPT to generate a simple dashboard in Google Sheets. It was a good learning opportunity as I found the key was keeping my prompts single step as much as possible. When I used multi-step prompts ChatGPT would do certain things and ignore others.  This is why it took a few days to create the script.  Will write more later.
